...
public class CameraViewActivity extends Activity implements
    ...
    private static final double DISTANCE_ACCURACY = 1000;
    private static final double AZIMUTH_ACCURACY = 1000;

    private double mMyLatitude = 0;
    private double mMyLongitude = 0;

    public static double TARGET_LATITUDE = 52.219575;
    public static double TARGET_LONGITUDE = 44.792549;
